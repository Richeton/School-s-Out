...
// window
const char CLASS_NAME[] = "School's Out!";
const char GAME_TITLE[] = "School's Out!";
const bool FULLSCREEN = false;              // windowed or fullscreen
const UINT GAME_ORIGIN_X = 0;
const UINT GAME_ORIGIN_Y = 0;
const UINT GAME_WIDTH = 512;               // width of game in pixels
const UINT GAME_HEIGHT = 512;               // height of game in pixels

const UINT GAME_BOUNDARY_XSTART = 0;
const UINT GAME_BOUNDARY_YSTART = (GAME_HEIGHT / 32 * 8);
const UINT GAME_BOUNDARY_XEND = GAME_WIDTH;
const UINT GAME_BOUNDARY_YEND = GAME_HEIGHT;
